...
CREATE TABLE `api_keys` (
  ...
  `r_impersonation` tinyint(3) unsigned NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
...
CREATE TABLE `extensions` (
  ...
  `target_version` varchar(191) DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `extensions_identifier_unique` (`identifier`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `server_categories` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `server_categories_user_id_foreign` (`user_id`),
  KEY `server_categories_uuid_index` (`uuid`),
  CONSTRAINT `server_categories_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `server_stats_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `server_stats_history` (
  ...
  `memory_bytes` bigint(20) unsigned NOT NULL DEFAULT 0,
  `disk_bytes` bigint(20) unsigned NOT NULL DEFAULT 0,
  `network_rx_bytes` bigint(20) unsigned NOT NULL DEFAULT 0,
  `network_tx_bytes` bigint(20) unsigned NOT NULL DEFAULT 0,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `server_stats_history_server_id_created_at_index` (`server_id`,`created_at`),
  CONSTRAINT `server_stats_history_server_id_foreign` FOREIGN KEY (`server_id`) REFERENCES `servers` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `servers` (
  ...
  CONSTRAINT `servers_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `server_categories` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `social_logins` (
  ...
  `provider_refresh_token` varchar(191) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `social_logins_provider_provider_user_id_unique` (`provider`,`provider_user_id`),
...
CREATE TABLE `users` (
  ...
  `editor` char(5) NOT NULL DEFAULT 'cm',
  PRIMARY KEY (`id`),
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (195,'2024_07_13_091852_clear_unused_allocation_notes',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (196,'2025_07_10_132323_add_banner_to_eggs',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (197,'2025_09_29_085302_custom_prelude_text',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (198,'2026_01_18_193719_create_server_stats_history_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (199,'2026_01_26_123932_create_social_logins_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (200,'2026_02_07_021434_update_users_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (201,'2026_02_12_174822_create_server_categories_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (202,'2026_02_12_174823_add_category_id_to_servers_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (203,'2026_02_12_182802_add_last_seen_to_users_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (204,'2026_02_12_194459_add_position_to_server_categories_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (205,'2026_03_11_000001_add_r_impersonation_to_api_keys_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (206,'2026_03_24_192341_create_extensions_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (207,'2026_03_25_114124_add_update_url_to_extensions_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (208,'2026_03_25_123339_replace_panel_docker_images',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (209,'2026_03_25_140807_drop_daemontext_column',2);
