...
return [
    ...
    'feedback-body' => 'Om du har uppskattat funktionerna och användarvänligheten som MerlinHost erbjuder, låt oss veta! Din feedback hjälper oss att förbättra och skapa ännu bättre verktyg för dig.',
    'feedback-btn' => 'Skapa ärende',
    'sponsor-header' => 'Stöd MerlinHost',
    'sponsor-body' => 'Tack för att du använder MerlinHost Panel. Detta har endast varit möjligt tack vare stödet från dig, våra bidragsgivare och alla andra som stöttar oss! Vi uppskattar allt stöd.',
