            ...
            {({ field, form: { errors, touched } }: FieldProps) => (
                <div>
                  ...
                  <div className="flex items-center">
                    {Icon && <IconWrapper className={touched[field.name] && errors[field.name] ? 'border-red-400 text-red-400' : 'border-gray-500 text-gray-500'}><Icon className="w-5 h-5" /></IconWrapper>}
                    <Input
