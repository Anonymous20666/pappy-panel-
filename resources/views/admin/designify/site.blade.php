    ...
    <form action="{{ route('admin.designify.site') }}" method="POST" class="h-full flex flex-col">
        ...
        <div class="flex-1 space-y-6 pb-[80px]">
            <div class="space-y-3">
                ...
                <input type="text" id="reviactyl:site_title" name="reviactyl:site_title"
            ...
            <div class="space-y-3">
                ...
                <input type="text" id="reviactyl:site_description" name="reviactyl:site_description"
            ...
            <div class="space-y-3">
                ...
                <div class="relative">
                    <input type="text" id="reviactyl:site_image" name="reviactyl:site_image"
            ...
            <div class="space-y-3">
                ...
                <div class="relative">
                    <input type="text" id="reviactyl:site_favicon" name="reviactyl:site_favicon"
            ...
            <div class="space-y-2">
                ...
                <div class="flex items-center space-x-2">
                    <input type="color" class="h-10 w-16 rounded border border-zinc-600 bg-zinc-700 cursor-pointer"
                        name="reviactyl:site_color" id="reviactyl:site_color"
                        value="{{ old('reviactyl:site_color', $site_color) }}" />
                </div>
            </div>
        </div>
        <div
            class="absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[612px] rounded-xl sm:border border-zinc-700 bg-zinc-950/60 pt-2 mt-6 px-4 mb-2">
...
@section('sidecontent')
    ...
    <div class="border border-zinc-600 p-4 max-w-xl rounded-lg text-white font-sans">
        ...
        <div
            class="bg-[#2b2d31] rounded-md border-l-4 border-[{{ old('reviactyl:site_color', $site_color) }}] rounded-r-md p-3">
            ...
            <div class="flex items-center space-x-3">
                <img src="{{ old('reviactyl:site_image', $site_image) }}" alt="site image"
