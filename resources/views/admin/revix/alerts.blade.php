...
<form action="{{ route('admin.revix.alerts') }}" method="POST" class="h-full flex flex-col">
    <div class="mb-8">
        ...
        <p class="text-gray-400 text-sm">Change the alert settings of Revix Theme.</p>
    </div>
    <div class="flex-1 space-y-6">
    <div class="space-y-3">
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300" for="revix:alertType">
            Alert Type
        </label>
        <select 
