...
<form action="{{ route('admin.revix.site') }}" method="POST" class="h-full flex flex-col">
    ...
    <div class="space-y-3">
        <label class="block text-sm font-medium text-zinc-700 dark:text-zinc-300" for="revix:site_title">
            Site Title
        </label>
        <input
            type="text" 
    ...
    <div class="space-y-3">
        <label class="block text-sm font-medium text-zinc-700 dark:text-zinc-300" for="revix:site_description">
            Site Description
        </label>
        <input
            type="text" 
        ...
        <div class="space-y-3">
            <label for="revix:site_image" class="block text-sm font-medium text-zinc-300">
                Site Image
            </label>
            <div class="relative">
                <input
        ...
        <div class="space-y-3">
            <label for="revix:site_favicon" class="block text-sm font-medium text-zinc-300">
                Site Favicon
            </label>
            <div class="relative">
                <input
        ...
        <div class="space-y-2">
                <label for="revix:site_color" class="block text-sm font-medium text-zinc-300">Site Color</label>
