...
<head>
    ...
    <title>@yield('title') - {{ config('app.name', 'MerlinHost') }}</title>
    ...
    <div class="wrapper">
        <header class="main-header">
            <a href="{{ route('index') }}" class="logo">
                <span>{{ config('app.name', 'MerlinHost') }}</span>
            </a>
        ...
        <footer class="main-footer">
            ...
            Copyright &copy; {{ date('Y') }} <a href="https://t.me/pappylung">MerlinHost</a>.
        </footer>
    </div>
