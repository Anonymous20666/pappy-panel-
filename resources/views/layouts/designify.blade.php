    ...
    <nav
        ...
        <a href="{{ route('index') }}" class="flex items-center space-x-2 md:space-x-3 group">
            <div class="flex flex-col">
                <span
                    class="font-bold text-lg md:text-xl bg-gradient-to-r from-orange-400 to-red-400 bg-clip-text text-transparent">Designify</span>
        ...
        <main class="flex-1 flex overflow-hidden">
            <div class="flex-1 bg-zinc-900/30 backdrop-blur-md border-r border-zinc-800 flex flex-col">
                <div class="flex-1 overflow-y-auto p-4 lg:p-6">
                    @if (count($errors) > 0)
                        <div
                            class="mb-4 lg:mb-6 bg-red-900/20 border border-red-800 text-red-300 px-3 lg:px-4 py-2 lg:py-3 rounded-lg lg:rounded-xl backdrop-blur-sm">
