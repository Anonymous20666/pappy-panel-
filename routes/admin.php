...
Route::group(['prefix' => 'settings'], function () {
    ...
    Route::get('/social', [Admin\Settings\SocialController::class, 'index'])->name('admin.settings.social');
    ...
    Route::patch('/social', [Admin\Settings\SocialController::class, 'update']);
});
