...
Route::post('/register', [Auth\RegisterController::class, 'register'])->name('auth.post.register')->middleware('throttle:10,5');
Route::post('/register/verify-telegram', [Auth\RegisterController::class, 'verifyTelegram'])->name('auth.verify-telegram')->middleware('throttle:20,5');
Route::get('/register', [Auth\RegisterController::class, 'index'])->name('auth.register');
